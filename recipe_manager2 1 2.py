...
class RecipeManager:
    ...
    def edit_recipe(self,recipe_name):
        for recipe in self.recipes:
            if recipe.name.lower().strip() == recipe_name.lower().strip():
                ...
                if edit_choice == "A":
                    ...
                    new_ingredients = input("Enter new recipe ingredients(comma-seperated):")
    ...
    def delete_recipe(self,recipe_name):
        for recipe in self.recipes:
            if recipe_name.lower().strip() == recipe.name.lower().strip():
